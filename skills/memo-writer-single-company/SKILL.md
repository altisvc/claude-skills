---
name: memo-writer-single-company
description: Investment memo skill calibrated on GC AI, Sandstone, and DeepJudge (March–April 2026). Prose-driven, ~10 pages, Key Debates without Bull/Bear labels, bold inline sub-headers, one quote per debate.
slash_command: /memo-writer-single-company
---
